 ...
 */class fe extends _t{constructor(e){if(super(e),this.it=g,e.type!==wt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===g||e==null)return this._t=void 0,this.it=e;if(e===j)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}fe.directiveName="unsafeHTML",fe.resultType=1;const T=$t(fe),At=`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  `;I([l({type:String})],_.prototype,"title",2);I([l({type:String})],_.prototype,"subtitle",2);I([l({type:String})],_.prototype,"buttonText",2);I([l({type:String})],_.prototype,"buttonHref",2);I([l({type:String})],_.prototype,"backgroundImage",2);_=I([v("trio-hero")],_);var Wt=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,ce=(r,e,i,s)=>{for(var t=s>1?void 0:s?qt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Wt(e,i,t),t};const Ie={gear:Ct,"app-window":Tt,robot:Pt,"presentation-chart":Ot,cloud:jt,lightbulb:qe,globe:Et,"device-mobile":Ht,code:Mt,video:Lt,"chart-line":Dt,headset:zt,users:Fe,briefcase:Zt,"list-checks":It,user:ke,rocket:Ye};function Ft(r){return Ie[r]||Ie.gear}let z=class extends u{constructor(){super(...arguments),this.icon="gear",this.title="",this.description=""}render(){return p`
  ...
  `;ce([l({type:String})],z.prototype,"icon",2);ce([l({type:String})],z.prototype,"title",2);ce([l({type:String})],z.prototype,"description",2);z=ce([v("trio-service-card")],z);var kt=Object.defineProperty,Yt=Object.getOwnPropertyDescriptor,Ke=(r,e,i,s)=>{for(var t=s>1?void 0:s?Yt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&kt(e,i,t),t};let ae=class extends u{constructor(){super(...arguments),this.services=[]}render(){return p`
