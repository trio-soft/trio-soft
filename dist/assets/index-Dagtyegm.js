 ...
 */const te=globalThis,fe=te.ShadowRoot&&(te.ShadyCSS===void 0||te.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,me=Symbol(),Te=new WeakMap;let Be=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==me)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(fe&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=Te.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&Te.set(i,e))}return e}toString(){return this.cssText}};const Qe=r=>new Be(typeof r=="string"?r:r+"",void 0,me),m=(r,...e)=>{const i=r.length===1?r[0]:e.reduce((s,t,a)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(t)+r[a+1],r[0]);return new Be(i,r,me)},Xe=(r,e)=>{if(fe)r.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),t=te.litNonce;t!==void 0&&s.setAttribute("nonce",t),s.textContent=i.cssText,r.appendChild(s)}},Oe=fe?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return Qe(i)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:et,defineProperty:tt,getOwnPropertyDescriptor:it,getOwnPropertyNames:st,getOwnPropertySymbols:rt,getPrototypeOf:at}=Object,y=globalThis,Pe=y.trustedTypes,ot=Pe?Pe.emptyScript:"",pe=y.reactiveElementPolyfillSupport,V=(r,e)=>r,ie={toAttribute(r,e){switch(e){case Boolean:r=r?ot:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let i=r;switch(e){case Boolean:i=r!==null;break;case Number:i=r===null?null:Number(r);break;case Object:case Array:try{i=JSON.parse(r)}catch{i=null}}return i}},ve=(r,e)=>!et(r,e),je={attribute:!0,type:String,converter:ie,reflect:!1,useDefault:!1,hasChanged:ve};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),y.litPropertyMetadata??(y.litPropertyMetadata=new WeakMap);let E=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=je){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),t=this.getPropertyDescriptor(e,s,i);t!==void 0&&tt(this.prototype,e,t)}}static getPropertyDescriptor(e,i,s){const{get:t,set:a}=it(this.prototype,e)??{get(){return this[i]},set(o){this[i]=o}};return{get:t,set(o){const l=t==null?void 0:t.call(this);a==null||a.call(this,o),this.requestUpdate(e,l,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??je}static _$Ei(){if(this.hasOwnProperty(V("elementProperties")))return;const e=at(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(V("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(V("properties"))){const i=this.properties,s=[...st(i),...rt(i)];for(const t of s)this.createProperty(t,i[t])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,t]of i)this.elementProperties.set(s,t)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const t=this._$Eu(i,s);t!==void 0&&this._$Eh.set(t,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const t of s)i.unshift(Oe(t))}else e!==void 0&&i.push(Oe(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(i=>i(this))}addController(e){var i;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)==null||i.call(e))}removeController(e){var i;(i=this._$EO)==null||i.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return Xe(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostConnected)==null?void 0:s.call(i)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostDisconnected)==null?void 0:s.call(i)})}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){var a;const s=this.constructor.elementProperties.get(e),t=this.constructor._$Eu(e,s);if(t!==void 0&&s.reflect===!0){const o=(((a=s.converter)==null?void 0:a.toAttribute)!==void 0?s.converter:ie).toAttribute(i,s.type);this._$Em=e,o==null?this.removeAttribute(t):this.setAttribute(t,o),this._$Em=null}}_$AK(e,i){var a,o;const s=this.constructor,t=s._$Eh.get(e);if(t!==void 0&&this._$Em!==t){const l=s.getPropertyOptions(t),n=typeof l.converter=="function"?{fromAttribute:l.converter}:((a=l.converter)==null?void 0:a.fromAttribute)!==void 0?l.converter:ie;this._$Em=t;const h=n.fromAttribute(i,l.type);this[t]=h??((o=this._$Ej)==null?void 0:o.get(t))??h,this._$Em=null}}requestUpdate(e,i,s,t=!1,a){var o;if(e!==void 0){const l=this.constructor;if(t===!1&&(a=this[e]),s??(s=l.getPropertyOptions(e)),!((s.hasChanged??ve)(a,i)||s.useDefault&&s.reflect&&a===((o=this._$Ej)==null?void 0:o.get(e))&&!this.hasAttribute(l._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:t,wrapped:a},o){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,o??i??this[e]),a!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),t===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[a,o]of this._$Ep)this[a]=o;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[a,o]of t){const{wrapped:l}=o,n=this[a];l!==!0||this._$AL.has(a)||n===void 0||this.C(a,void 0,o,n)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),(s=this._$EO)==null||s.forEach(t=>{var a;return(a=t.hostUpdate)==null?void 0:a.call(t)}),this.update(i)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(i)}willUpdate(e){}_$AE(e){var i;(i=this._$EO)==null||i.forEach(s=>{var t;return(t=s.hostUpdated)==null?void 0:t.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(i=>this._$ET(i,this[i]))),this._$EM()}updated(e){}firstUpdated(e){}};E.elementStyles=[],E.shadowRootOptions={mode:"open"},E[V("elementProperties")]=new Map,E[V("finalized")]=new Map,pe==null||pe({ReactiveElement:E}),(y.reactiveElementVersions??(y.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const z=globalThis,Ee=r=>r,se=z.trustedTypes,He=se?se.createPolicy("lit-html",{createHTML:r=>r}):void 0,Ue="$lit$",w=`lit$${Math.random().toFixed(9).slice(2)}$`,Ne="?"+w,nt=`<${Ne}>`,T=document,B=()=>T.createComment(""),U=r=>r===null||typeof r!="object"&&typeof r!="function",be=Array.isArray,lt=r=>be(r)||typeof(r==null?void 0:r[Symbol.iterator])=="function",de=`[ 	
\f\r]`,I=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Me=/-->/g,Le=/>/g,_=RegExp(`>|${de}(?:([^\\s"'>=/]+)(${de}*=${de}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),De=/'/g,Ze=/"/g,Re=/^(?:script|style|textarea|title)$/i,ct=r=>(e,...i)=>({_$litType$:r,strings:e,values:i}),p=ct(1),O=Symbol.for("lit-noChange"),g=Symbol.for("lit-nothing"),Ie=new WeakMap,A=T.createTreeWalker(T,129);function Ge(r,e){if(!be(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return He!==void 0?He.createHTML(e):e}const pt=(r,e)=>{const i=r.length-1,s=[];let t,a=e===2?"<svg>":e===3?"<math>":"",o=I;for(let l=0;l<i;l++){const n=r[l];let h,f,d=-1,b=0;for(;b<n.length&&(o.lastIndex=b,f=o.exec(n),f!==null);)b=o.lastIndex,o===I?f[1]==="!--"?o=Me:f[1]!==void 0?o=Le:f[2]!==void 0?(Re.test(f[2])&&(t=RegExp("</"+f[2],"g")),o=_):f[3]!==void 0&&(o=_):o===_?f[0]===">"?(o=t??I,d=-1):f[1]===void 0?d=-2:(d=o.lastIndex-f[2].length,h=f[1],o=f[3]===void 0?_:f[3]==='"'?Ze:De):o===Ze||o===De?o=_:o===Me||o===Le?o=I:(o=_,t=void 0);const x=o===_&&r[l+1].startsWith("/>")?" ":"";a+=o===I?n+nt:d>=0?(s.push(h),n.slice(0,d)+Ue+n.slice(d)+w+x):n+w+(d===-2?l:x)}return[Ge(r,a+(r[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class N{constructor({strings:e,_$litType$:i},s){let t;this.parts=[];let a=0,o=0;const l=e.length-1,n=this.parts,[h,f]=pt(e,i);if(this.el=N.createElement(h,s),A.currentNode=this.el.content,i===2||i===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(t=A.nextNode())!==null&&n.length<l;){if(t.nodeType===1){if(t.hasAttributes())for(const d of t.getAttributeNames())if(d.endsWith(Ue)){const b=f[o++],x=t.getAttribute(d).split(w),ee=/([.?@])?(.*)/.exec(b);n.push({type:1,index:a,name:ee[2],strings:x,ctor:ee[1]==="."?ht:ee[1]==="?"?gt:ee[1]==="@"?ut:oe}),t.removeAttribute(d)}else d.startsWith(w)&&(n.push({type:6,index:a}),t.removeAttribute(d));if(Re.test(t.tagName)){const d=t.textContent.split(w),b=d.length-1;if(b>0){t.textContent=se?se.emptyScript:"";for(let x=0;x<b;x++)t.append(d[x],B()),A.nextNode(),n.push({type:2,index:++a});t.append(d[b],B())}}}else if(t.nodeType===8)if(t.data===Ne)n.push({type:2,index:a});else{let d=-1;for(;(d=t.data.indexOf(w,d+1))!==-1;)n.push({type:7,index:a}),d+=w.length-1}a++}}static createElement(e,i){const s=T.createElement("template");return s.innerHTML=e,s}}function H(r,e,i=r,s){var o,l;if(e===O)return e;let t=s!==void 0?(o=i._$Co)==null?void 0:o[s]:i._$Cl;const a=U(e)?void 0:e._$litDirective$;return(t==null?void 0:t.constructor)!==a&&((l=t==null?void 0:t._$AO)==null||l.call(t,!1),a===void 0?t=void 0:(t=new a(r),t._$AT(r,i,s)),s!==void 0?(i._$Co??(i._$Co=[]))[s]=t:i._$Cl=t),t!==void 0&&(e=H(r,t._$AS(r,e.values),t,s)),e}class dt{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,t=((e==null?void 0:e.creationScope)??T).importNode(i,!0);A.currentNode=t;let a=A.nextNode(),o=0,l=0,n=s[0];for(;n!==void 0;){if(o===n.index){let h;n.type===2?h=new J(a,a.nextSibling,this,e):n.type===1?h=new n.ctor(a,n.name,n.strings,this,e):n.type===6&&(h=new ft(a,this,e)),this._$AV.push(h),n=s[++l]}o!==(n==null?void 0:n.index)&&(a=A.nextNode(),o++)}return A.currentNode=T,t}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class J{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,i,s,t){this.type=2,this._$AH=g,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=t,this._$Cv=(t==null?void 0:t.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=H(this,e,i),U(e)?e===g||e==null||e===""?(this._$AH!==g&&this._$AR(),this._$AH=g):e!==this._$AH&&e!==O&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):lt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==g&&U(this._$AH)?this._$AA.nextSibling.data=e:this.T(T.createTextNode(e)),this._$AH=e}$(e){var a;const{values:i,_$litType$:s}=e,t=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=N.createElement(Ge(s.h,s.h[0]),this.options)),s);if(((a=this._$AH)==null?void 0:a._$AD)===t)this._$AH.p(i);else{const o=new dt(t,this),l=o.u(this.options);o.p(i),this.T(l),this._$AH=o}}_$AC(e){let i=Ie.get(e.strings);return i===void 0&&Ie.set(e.strings,i=new N(e)),i}k(e){be(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,t=0;for(const a of e)t===i.length?i.push(s=new J(this.O(B()),this.O(B()),this,this.options)):s=i[t],s._$AI(a),t++;t<i.length&&(this._$AR(s&&s._$AB.nextSibling,t),i.length=t)}_$AR(e=this._$AA.nextSibling,i){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,i);e!==this._$AB;){const t=Ee(e).nextSibling;Ee(e).remove(),e=t}}setConnected(e){var i;this._$AM===void 0&&(this._$Cv=e,(i=this._$AP)==null||i.call(this,e))}}class oe{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,t,a){this.type=1,this._$AH=g,this._$AN=void 0,this.element=e,this.name=i,this._$AM=t,this.options=a,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=g}_$AI(e,i=this,s,t){const a=this.strings;let o=!1;if(a===void 0)e=H(this,e,i,0),o=!U(e)||e!==this._$AH&&e!==O,o&&(this._$AH=e);else{const l=e;let n,h;for(e=a[0],n=0;n<a.length-1;n++)h=H(this,l[s+n],i,n),h===O&&(h=this._$AH[n]),o||(o=!U(h)||h!==this._$AH[n]),h===g?e=g:e!==g&&(e+=(h??"")+a[n+1]),this._$AH[n]=h}o&&!t&&this.j(e)}j(e){e===g?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class ht extends oe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===g?void 0:e}}class gt extends oe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==g)}}class ut extends oe{constructor(e,i,s,t,a){super(e,i,s,t,a),this.type=5}_$AI(e,i=this){if((e=H(this,e,i,0)??g)===O)return;const s=this._$AH,t=e===g&&s!==g||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,a=e!==g&&(s===g||t);t&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,e):this._$AH.handleEvent(e)}}class ft{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){H(this,e)}}const he=z.litHtmlPolyfillSupport;he==null||he(N,J),(z.litHtmlVersions??(z.litHtmlVersions=[])).push("3.3.2");const mt=(r,e,i)=>{const s=(i==null?void 0:i.renderBefore)??e;let t=s._$litPart$;if(t===void 0){const a=(i==null?void 0:i.renderBefore)??null;s._$litPart$=t=new J(e.insertBefore(B(),a),a,void 0,i??{})}return t._$AI(r),t};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const C=globalThis;let u=class extends E{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var i;const e=super.createRenderRoot();return(i=this.renderOptions).renderBefore??(i.renderBefore=e.firstChild),e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=mt(i,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return O}};var ze;u._$litElement$=!0,u.finalized=!0,(ze=C.litElementHydrateSupport)==null||ze.call(C,{LitElement:u});const ge=C.litElementPolyfillSupport;ge==null||ge({LitElement:u});(C.litElementVersions??(C.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */class ue extends _t{constructor(e){if(super(e),this.it=g,e.type!==yt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===g||e==null)return this._t=void 0,this.it=e;if(e===O)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}ue.directiveName="unsafeHTML",ue.resultType=1;const S=$t(ue),At=`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,St=`<svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
...
</svg>`,Pt=`<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
...
</svg>`,Fe=`<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
...
</svg>`;var zt=Object.defineProperty,Bt=Object.getOwnPropertyDescriptor,xe=(r,e,i,s)=>{for(var t=s>1?void 0:s?Bt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&zt(e,i,t),t};let R=class extends u{constructor(){super(...arguments),this.lang="en",this.data={brand:"Trio-Soft",nav:[],getStarted:"Get Started"}}render(){const r="#/language",e=this.lang==="jp"?"#/jp/":"#/",i=this.lang==="jp"?"#/jp/contact":"#/contact";return p`
      <header class="header">
        <div class="header-brand">
          <div class="header-logo">${S(At)}</div>
          <a class="header-brand-name" href="${e}">${this.data.brand}</a>
        </div>
        <div class="header-right">
          <nav class="header-nav">
            ${this.data.nav.map(s=>p`<a class="header-nav-link" href="${s.href}">${s.label}</a>`)}
          </nav>
          <div class="header-actions">
            <a class="header-cta-btn" href="${i}">${this.data.getStarted}</a>
            <a class="header-lang-btn" href="${r}" title="Change language">${S(St)}</a>
          </div>
        </div>
      </header>
    `}};R.styles=m`
  ...
  `;xe([c({type:String})],R.prototype,"lang",2);xe([c({type:Object})],R.prototype,"data",2);R=xe([v("trio-header")],R);var Ut=Object.defineProperty,Nt=Object.getOwnPropertyDescriptor,ne=(r,e,i,s)=>{for(var t=s>1?void 0:s?Nt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Ut(e,i,t),t};let M=class extends u{constructor(){super(...arguments),this.privacyPolicy="Privacy Policy",this.termsOfService="Terms of Service",this.copyright="© 2025 Trio-Soft. All rights reserved."}render(){return p`
  ...
  `;ne([c({type:String})],M.prototype,"privacyPolicy",2);ne([c({type:String})],M.prototype,"termsOfService",2);ne([c({type:String})],M.prototype,"copyright",2);M=ne([v("trio-footer")],M);var Rt=Object.defineProperty,Gt=Object.getOwnPropertyDescriptor,Z=(r,e,i,s)=>{for(var t=s>1?void 0:s?Gt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Rt(e,i,t),t};let $=class extends u{constructor(){super(...arguments),this.title="",this.subtitle="",this.buttonText="",this.buttonHref="",this.backgroundImage="/img/hero-en.jpg"}render(){return p`
  ...
  `;Z([c({type:String})],$.prototype,"title",2);Z([c({type:String})],$.prototype,"subtitle",2);Z([c({type:String})],$.prototype,"buttonText",2);Z([c({type:String})],$.prototype,"buttonHref",2);Z([c({type:String})],$.prototype,"backgroundImage",2);$=Z([v("trio-hero")],$);var Wt=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,le=(r,e,i,s)=>{for(var t=s>1?void 0:s?qt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Wt(e,i,t),t};const Ve={gear:Ct,"app-window":Tt,robot:Ot,"presentation-chart":Pt,cloud:jt,lightbulb:qe,globe:Et,"device-mobile":Ht,code:Mt,video:Lt,"chart-line":Dt,headset:Zt,users:Fe,briefcase:It,"list-checks":Vt,user:Ye,rocket:ke};function Ft(r){return Ve[r]||Ve.gear}let L=class extends u{constructor(){super(...arguments),this.icon="gear",this.title="",this.description=""}render(){return p`
      <div class="service-card">
        <div class="service-card-icon">${S(Ft(this.icon))}</div>
  ...
  `;le([c({type:String})],L.prototype,"icon",2);le([c({type:String})],L.prototype,"title",2);le([c({type:String})],L.prototype,"description",2);L=le([v("trio-service-card")],L);var Yt=Object.defineProperty,kt=Object.getOwnPropertyDescriptor,Ke=(r,e,i,s)=>{for(var t=s>1?void 0:s?kt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Yt(e,i,t),t};let re=class extends u{constructor(){super(...arguments),this.services=[]}render(){return p`
  ...
  `;Ke([c({type:Array})],re.prototype,"services",2);re=Ke([v("trio-service-grid")],re);var Kt=Object.defineProperty,Jt=Object.getOwnPropertyDescriptor,ce=(r,e,i,s)=>{for(var t=s>1?void 0:s?Jt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Kt(e,i,t),t};let D=class extends u{constructor(){super(...arguments),this.image="",this.title="",this.description=""}render(){return p`<div class="case-card"><div class="case-card-image-wrap"><img class="case-card-image" src="${this.image}" alt="${this.title}" /></div><div class="case-card-body"><p class="case-card-title">${this.title}</p><p class="case-card-description">${this.description}</p></div></div>`}};D.styles=m`
    :host { display: flex; }
  ...
  `;ce([c({type:String})],D.prototype,"image",2);ce([c({type:String})],D.prototype,"title",2);ce([c({type:String})],D.prototype,"description",2);D=ce([v("trio-case-card")],D);var Qt=Object.defineProperty,Xt=Object.getOwnPropertyDescriptor,we=(r,e,i,s)=>{for(var t=s>1?void 0:s?Xt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Qt(e,i,t),t};let G=class extends u{constructor(){super(...arguments),this.cases=[],this.scrollable=!1}render(){const r=this.scrollable?"case-list-scrollable":"case-list-vertical";return p`
      <div class="${r}">
  ...
  `;we([c({type:Array})],G.prototype,"cases",2);we([c({type:Boolean})],G.prototype,"scrollable",2);G=we([v("trio-case-list")],G);var ei=Object.defineProperty,ti=Object.getOwnPropertyDescriptor,Q=(r,e,i,s)=>{for(var t=s>1?void 0:s?ti(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&ei(e,i,t),t};let P=class extends u{constructor(){super(...arguments),this.category="",this.title="",this.description="",this.image=""}render(){return p`<div class="news-item"><div class="news-item-text"><p class="news-item-category">${this.category}</p><p class="news-item-title">${this.title}</p><p class="news-item-description">${this.description}</p></div><div class="news-item-image-wrap"><img class="news-item-image" src="${this.image}" alt="${this.title}" /></div></div>`}};P.styles=m`
    :host { display: block; }
  ...
  `;Q([c({type:String})],P.prototype,"category",2);Q([c({type:String})],P.prototype,"title",2);Q([c({type:String})],P.prototype,"description",2);Q([c({type:String})],P.prototype,"image",2);P=Q([v("trio-news-item")],P);var ii=Object.defineProperty,si=Object.getOwnPropertyDescriptor,X=(r,e,i,s)=>{for(var t=s>1?void 0:s?si(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&ii(e,i,t),t};let j=class extends u{constructor(){super(...arguments),this.title="",this.subtitle="",this.buttonText="",this.lang="en"}render(){const r=this.lang==="jp"?"#/jp/contact":"#/contact";return p`
      <div class="cta-wrap">
        <div class="cta-box">
          <div class="cta-text">
  ...
  `;X([c({type:String})],j.prototype,"title",2);X([c({type:String})],j.prototype,"subtitle",2);X([c({type:String})],j.prototype,"buttonText",2);X([c({type:String})],j.prototype,"lang",2);j=X([v("trio-cta-section")],j);var ri=Object.defineProperty,ai=Object.getOwnPropertyDescriptor,ye=(r,e,i,s)=>{for(var t=s>1?void 0:s?ai(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&ri(e,i,t),t};let W=class extends u{constructor(){super(...arguments),this.data={},this.lang="en"}render(){const r=this.data.home,e=this.lang==="jp"?"#/jp/services":"#/services",i=this.lang==="jp"?"#/jp/contact":"#/contact",s=this.lang==="jp"?"/img/hero-jp.jpg":"/img/hero-en.jpg";return p`
    ...
    .intro-wrap { display: flex; flex-direction: column; gap: 40px; padding: 40px 16px; }
    .intro-head { display: flex; flex-direction: column; gap: 16px; }
    .intro-title { color: #0e141b; font-size: clamp(32px, 4vw, 36px); font-weight: 900; line-height: 1.2; letter-spacing: -0.033em; margin: 0; max-width: 720px; }
    .intro-desc { color: #0e141b; font-size: 16px; line-height: 1.5; margin: 0; max-width: 720px; }
    .news-list { display: flex; flex-direction: column; }
  `;ye([c({type:Object})],W.prototype,"data",2);ye([c({type:String})],W.prototype,"lang",2);W=ye([v("page-home")],W);var oi=Object.defineProperty,ni=Object.getOwnPropertyDescriptor,$e=(r,e,i,s)=>{for(var t=s>1?void 0:s?ni(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&oi(e,i,t),t};let q=class extends u{constructor(){super(...arguments),this.data={},this.lang="en"}render(){const r=this.data.services,e=this.lang==="jp"?"#/jp/contact":"#/contact";return p`<div class="page-head"><div class="page-head-box"><p class="page-title">${r.pageTitle}</p><p class="page-subtitle">${r.pageSubtitle}</p></div></div>${r.sections.map(i=>p`<h2 class="section-title">${i.title}</h2><div class="grid-wrap"><trio-service-grid .services=${i.cards}></trio-service-grid></div>`)}<trio-cta-section .title=${r.ctaTitle} .subtitle=${r.ctaSubtitle} .buttonText=${r.ctaButton} .buttonHref=${e} tone="blue"></trio-cta-section>`}};q.styles=m`
    :host { display: block; }
  ...
  `;$e([c({type:Object})],q.prototype,"data",2);$e([c({type:String})],q.prototype,"lang",2);q=$e([v("page-services")],q);var li=Object.defineProperty,ci=Object.getOwnPropertyDescriptor,_e=(r,e,i,s)=>{for(var t=s>1?void 0:s?ci(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&li(e,i,t),t};let F=class extends u{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return p`
      <div class="container">
        <div class="header-section">
          <h1 class="page-title">${this.data.pageTitle}</h1>
        </div>

        <trio-case-list .cases=${this.data.items} .scrollable=${!1}></trio-case-list>
  ...
  `;_e([c({type:String})],F.prototype,"lang",2);_e([c({type:Object})],F.prototype,"data",2);F=_e([v("page-cases")],F);var pi=Object.defineProperty,di=Object.getOwnPropertyDescriptor,Ae=(r,e,i,s)=>{for(var t=s>1?void 0:s?di(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&pi(e,i,t),t};let Y=class extends u{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return p`
      <div class="container">
        <div class="header-section">
          <h1 class="page-title">${this.data.pageTitle}</h1>
        </div>
  ...
  `;Ae([c({type:String})],Y.prototype,"lang",2);Ae([c({type:Object})],Y.prototype,"data",2);Y=Ae([v("page-about")],Y);var hi=Object.defineProperty,gi=Object.getOwnPropertyDescriptor,Se=(r,e,i,s)=>{for(var t=s>1?void 0:s?gi(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&hi(e,i,t),t};let k=class extends u{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return p`
      <div class="container">
        <div class="header-section">
          <div class="title-group">
            <h1 class="page-title">${this.data.pageTitle}</h1>
  ...
  `;Se([c({type:String})],k.prototype,"lang",2);Se([c({type:Object})],k.prototype,"data",2);k=Se([v("page-contact")],k);var ui=Object.defineProperty,fi=Object.getOwnPropertyDescriptor,Je=(r,e,i,s)=>{for(var t=s>1?void 0:s?fi(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&ui(e,i,t),t};let ae=class extends u{constructor(){super(...arguments),this.data={}}render(){return p`
      <div class="wrapper">
        <div class="content">
          <div class="header">
  ...
  `;Je([c({type:Object})],ae.prototype,"data",2);ae=Je([v("trio-language-selector")],ae);var mi=Object.defineProperty,vi=Object.getOwnPropertyDescriptor,Ce=(r,e,i,s)=>{for(var t=s>1?void 0:s?vi(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&mi(e,i,t),t};let K=class extends u{constructor(){super(),this.route=window.location.hash||"#/",this.lang=this.route.startsWith("#/jp")?"jp":"en",window.addEventListener("hashchange",()=>{this.route=window.location.hash||"#/",this.lang=this.route.startsWith("#/jp")?"jp":"en",window.scrollTo(0,0)})}render(){const r=this.lang==="jp"?wt:xt;return p`
    ...
    `}renderPage(r){switch(this.lang==="jp"?this.route.replace("#/jp","")||"/":this.route.replace("#","")||"/"){case"/":return p`<page-home .lang=${this.lang} .data=${r.home}></page-home>`;case"/services":return p`<page-services .lang=${this.lang} .data=${r.services}></page-services>`;case"/cases":return p`<page-cases .lang=${this.lang} .data=${r.cases}></page-cases>`;case"/about":return p`<page-about .lang=${this.lang} .data=${r.about}></page-about>`;case"/contact":return p`<page-contact .lang=${this.lang} .data=${r.contact}></page-contact>`;default:return p`<page-home .lang=${this.lang} .data=${r.home}></page-home>`}}};K.styles=m`
    :host {
      display: block;
      min-h-screen: 100vh;
  ...
  `;Ce([We()],K.prototype,"route",2);Ce([We()],K.prototype,"lang",2);K=Ce([v("trio-app")],K);
