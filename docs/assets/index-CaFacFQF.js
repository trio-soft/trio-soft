 ...
 */const ae=globalThis,ye=ae.ShadowRoot&&(ae.ShadyCSS===void 0||ae.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,xe=Symbol(),He=new WeakMap;let Ge=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==xe)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(ye&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=He.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&He.set(i,e))}return e}toString(){return this.cssText}};const it=r=>new Ge(typeof r=="string"?r:r+"",void 0,xe),f=(r,...e)=>{const i=r.length===1?r[0]:e.reduce((s,t,a)=>s+(o=>{if(o._$cssResult$===!0)return o.cssText;if(typeof o=="number")return o;throw Error("Value passed to 'css' function must be a 'css' function result: "+o+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(t)+r[a+1],r[0]);return new Ge(i,r,xe)},st=(r,e)=>{if(ye)r.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),t=ae.litNonce;t!==void 0&&s.setAttribute("nonce",t),s.textContent=i.cssText,r.appendChild(s)}},Me=ye?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return it(i)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:rt,defineProperty:at,getOwnPropertyDescriptor:ot,getOwnPropertyNames:nt,getOwnPropertySymbols:lt,getPrototypeOf:ct}=Object,_=globalThis,ze=_.trustedTypes,pt=ze?ze.emptyScript:"",ue=_.reactiveElementPolyfillSupport,R=(r,e)=>r,oe={toAttribute(r,e){switch(e){case Boolean:r=r?pt:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let i=r;switch(e){case Boolean:i=r!==null;break;case Number:i=r===null?null:Number(r);break;case Object:case Array:try{i=JSON.parse(r)}catch{i=null}}return i}},we=(r,e)=>!rt(r,e),Le={attribute:!0,type:String,converter:oe,reflect:!1,useDefault:!1,hasChanged:we};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),_.litPropertyMetadata??(_.litPropertyMetadata=new WeakMap);let z=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Le){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),t=this.getPropertyDescriptor(e,s,i);t!==void 0&&at(this.prototype,e,t)}}static getPropertyDescriptor(e,i,s){const{get:t,set:a}=ot(this.prototype,e)??{get(){return this[i]},set(o){this[i]=o}};return{get:t,set(o){const c=t==null?void 0:t.call(this);a==null||a.call(this,o),this.requestUpdate(e,c,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Le}static _$Ei(){if(this.hasOwnProperty(R("elementProperties")))return;const e=ct(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(R("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(R("properties"))){const i=this.properties,s=[...nt(i),...lt(i)];for(const t of s)this.createProperty(t,i[t])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,t]of i)this.elementProperties.set(s,t)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const t=this._$Eu(i,s);t!==void 0&&this._$Eh.set(t,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const t of s)i.unshift(Me(t))}else e!==void 0&&i.push(Me(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(i=>i(this))}addController(e){var i;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)==null||i.call(e))}removeController(e){var i;(i=this._$EO)==null||i.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return st(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostConnected)==null?void 0:s.call(i)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostDisconnected)==null?void 0:s.call(i)})}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){var a;const s=this.constructor.elementProperties.get(e),t=this.constructor._$Eu(e,s);if(t!==void 0&&s.reflect===!0){const o=(((a=s.converter)==null?void 0:a.toAttribute)!==void 0?s.converter:oe).toAttribute(i,s.type);this._$Em=e,o==null?this.removeAttribute(t):this.setAttribute(t,o),this._$Em=null}}_$AK(e,i){var a,o;const s=this.constructor,t=s._$Eh.get(e);if(t!==void 0&&this._$Em!==t){const c=s.getPropertyOptions(t),l=typeof c.converter=="function"?{fromAttribute:c.converter}:((a=c.converter)==null?void 0:a.fromAttribute)!==void 0?c.converter:oe;this._$Em=t;const g=l.fromAttribute(i,c.type);this[t]=g??((o=this._$Ej)==null?void 0:o.get(t))??g,this._$Em=null}}requestUpdate(e,i,s,t=!1,a){var o;if(e!==void 0){const c=this.constructor;if(t===!1&&(a=this[e]),s??(s=c.getPropertyOptions(e)),!((s.hasChanged??we)(a,i)||s.useDefault&&s.reflect&&a===((o=this._$Ej)==null?void 0:o.get(e))&&!this.hasAttribute(c._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:t,wrapped:a},o){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,o??i??this[e]),a!==!0||o!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),t===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[a,o]of this._$Ep)this[a]=o;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[a,o]of t){const{wrapped:c}=o,l=this[a];c!==!0||this._$AL.has(a)||l===void 0||this.C(a,void 0,o,l)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),(s=this._$EO)==null||s.forEach(t=>{var a;return(a=t.hostUpdate)==null?void 0:a.call(t)}),this.update(i)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(i)}willUpdate(e){}_$AE(e){var i;(i=this._$EO)==null||i.forEach(s=>{var t;return(t=s.hostUpdated)==null?void 0:t.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(i=>this._$ET(i,this[i]))),this._$EM()}updated(e){}firstUpdated(e){}};z.elementStyles=[],z.shadowRootOptions={mode:"open"},z[R("elementProperties")]=new Map,z[R("finalized")]=new Map,ue==null||ue({ReactiveElement:z}),(_.reactiveElementVersions??(_.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const N=globalThis,De=r=>r,ne=N.trustedTypes,Ie=ne?ne.createPolicy("lit-html",{createHTML:r=>r}):void 0,qe="$lit$",$=`lit$${Math.random().toFixed(9).slice(2)}$`,Fe="?"+$,dt=`<${Fe}>`,O=document,W=()=>O.createComment(""),G=r=>r===null||typeof r!="object"&&typeof r!="function",$e=Array.isArray,ht=r=>$e(r)||typeof(r==null?void 0:r[Symbol.iterator])=="function",fe=`[ 	
\f\r]`,U=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ze=/-->/g,Ve=/>/g,C=RegExp(`>|${fe}(?:([^\\s"'>=/]+)(${fe}*=${fe}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Be=/'/g,Ue=/"/g,Ye=/^(?:script|style|textarea|title)$/i,gt=r=>(e,...i)=>({_$litType$:r,strings:e,values:i}),p=gt(1),E=Symbol.for("lit-noChange"),u=Symbol.for("lit-nothing"),Re=new WeakMap,P=O.createTreeWalker(O,129);function Ke(r,e){if(!$e(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ie!==void 0?Ie.createHTML(e):e}const ut=(r,e)=>{const i=r.length-1,s=[];let t,a=e===2?"<svg>":e===3?"<math>":"",o=U;for(let c=0;c<i;c++){const l=r[c];let g,v,d=-1,b=0;for(;b<l.length&&(o.lastIndex=b,v=o.exec(l),v!==null);)b=o.lastIndex,o===U?v[1]==="!--"?o=Ze:v[1]!==void 0?o=Ve:v[2]!==void 0?(Ye.test(v[2])&&(t=RegExp("</"+v[2],"g")),o=C):v[3]!==void 0&&(o=C):o===C?v[0]===">"?(o=t??U,d=-1):v[1]===void 0?d=-2:(d=o.lastIndex-v[2].length,g=v[1],o=v[3]===void 0?C:v[3]==='"'?Ue:Be):o===Ue||o===Be?o=C:o===Ze||o===Ve?o=U:(o=C,t=void 0);const w=o===C&&r[c+1].startsWith("/>")?" ":"";a+=o===U?l+dt:d>=0?(s.push(g),l.slice(0,d)+qe+l.slice(d)+$+w):l+$+(d===-2?c:w)}return[Ke(r,a+(r[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class q{constructor({strings:e,_$litType$:i},s){let t;this.parts=[];let a=0,o=0;const c=e.length-1,l=this.parts,[g,v]=ut(e,i);if(this.el=q.createElement(g,s),P.currentNode=this.el.content,i===2||i===3){const d=this.el.content.firstChild;d.replaceWith(...d.childNodes)}for(;(t=P.nextNode())!==null&&l.length<c;){if(t.nodeType===1){if(t.hasAttributes())for(const d of t.getAttributeNames())if(d.endsWith(qe)){const b=v[o++],w=t.getAttribute(d).split($),re=/([.?@])?(.*)/.exec(b);l.push({type:1,index:a,name:re[2],strings:w,ctor:re[1]==="."?mt:re[1]==="?"?vt:re[1]==="@"?bt:pe}),t.removeAttribute(d)}else d.startsWith($)&&(l.push({type:6,index:a}),t.removeAttribute(d));if(Ye.test(t.tagName)){const d=t.textContent.split($),b=d.length-1;if(b>0){t.textContent=ne?ne.emptyScript:"";for(let w=0;w<b;w++)t.append(d[w],W()),P.nextNode(),l.push({type:2,index:++a});t.append(d[b],W())}}}else if(t.nodeType===8)if(t.data===Fe)l.push({type:2,index:a});else{let d=-1;for(;(d=t.data.indexOf($,d+1))!==-1;)l.push({type:7,index:a}),d+=$.length-1}a++}}static createElement(e,i){const s=O.createElement("template");return s.innerHTML=e,s}}function L(r,e,i=r,s){var o,c;if(e===E)return e;let t=s!==void 0?(o=i._$Co)==null?void 0:o[s]:i._$Cl;const a=G(e)?void 0:e._$litDirective$;return(t==null?void 0:t.constructor)!==a&&((c=t==null?void 0:t._$AO)==null||c.call(t,!1),a===void 0?t=void 0:(t=new a(r),t._$AT(r,i,s)),s!==void 0?(i._$Co??(i._$Co=[]))[s]=t:i._$Cl=t),t!==void 0&&(e=L(r,t._$AS(r,e.values),t,s)),e}class ft{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,t=((e==null?void 0:e.creationScope)??O).importNode(i,!0);P.currentNode=t;let a=P.nextNode(),o=0,c=0,l=s[0];for(;l!==void 0;){if(o===l.index){let g;l.type===2?g=new ie(a,a.nextSibling,this,e):l.type===1?g=new l.ctor(a,l.name,l.strings,this,e):l.type===6&&(g=new yt(a,this,e)),this._$AV.push(g),l=s[++c]}o!==(l==null?void 0:l.index)&&(a=P.nextNode(),o++)}return P.currentNode=O,t}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class ie{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,i,s,t){this.type=2,this._$AH=u,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=t,this._$Cv=(t==null?void 0:t.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=L(this,e,i),G(e)?e===u||e==null||e===""?(this._$AH!==u&&this._$AR(),this._$AH=u):e!==this._$AH&&e!==E&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):ht(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==u&&G(this._$AH)?this._$AA.nextSibling.data=e:this.T(O.createTextNode(e)),this._$AH=e}$(e){var a;const{values:i,_$litType$:s}=e,t=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=q.createElement(Ke(s.h,s.h[0]),this.options)),s);if(((a=this._$AH)==null?void 0:a._$AD)===t)this._$AH.p(i);else{const o=new ft(t,this),c=o.u(this.options);o.p(i),this.T(c),this._$AH=o}}_$AC(e){let i=Re.get(e.strings);return i===void 0&&Re.set(e.strings,i=new q(e)),i}k(e){$e(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,t=0;for(const a of e)t===i.length?i.push(s=new ie(this.O(W()),this.O(W()),this,this.options)):s=i[t],s._$AI(a),t++;t<i.length&&(this._$AR(s&&s._$AB.nextSibling,t),i.length=t)}_$AR(e=this._$AA.nextSibling,i){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,i);e!==this._$AB;){const t=De(e).nextSibling;De(e).remove(),e=t}}setConnected(e){var i;this._$AM===void 0&&(this._$Cv=e,(i=this._$AP)==null||i.call(this,e))}}class pe{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,t,a){this.type=1,this._$AH=u,this._$AN=void 0,this.element=e,this.name=i,this._$AM=t,this.options=a,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=u}_$AI(e,i=this,s,t){const a=this.strings;let o=!1;if(a===void 0)e=L(this,e,i,0),o=!G(e)||e!==this._$AH&&e!==E,o&&(this._$AH=e);else{const c=e;let l,g;for(e=a[0],l=0;l<a.length-1;l++)g=L(this,c[s+l],i,l),g===E&&(g=this._$AH[l]),o||(o=!G(g)||g!==this._$AH[l]),g===u?e=u:e!==u&&(e+=(g??"")+a[l+1]),this._$AH[l]=g}o&&!t&&this.j(e)}j(e){e===u?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class mt extends pe{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===u?void 0:e}}class vt extends pe{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==u)}}class bt extends pe{constructor(e,i,s,t,a){super(e,i,s,t,a),this.type=5}_$AI(e,i=this){if((e=L(this,e,i,0)??u)===E)return;const s=this._$AH,t=e===u&&s!==u||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,a=e!==u&&(s===u||t);t&&this.element.removeEventListener(this.name,this,s),a&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,e):this._$AH.handleEvent(e)}}class yt{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){L(this,e)}}const me=N.litHtmlPolyfillSupport;me==null||me(q,ie),(N.litHtmlVersions??(N.litHtmlVersions=[])).push("3.3.2");const xt=(r,e,i)=>{const s=(i==null?void 0:i.renderBefore)??e;let t=s._$litPart$;if(t===void 0){const a=(i==null?void 0:i.renderBefore)??null;s._$litPart$=t=new ie(e.insertBefore(W(),a),a,void 0,i??{})}return t._$AI(r),t};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const j=globalThis;let h=class extends z{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var i;const e=super.createRenderRoot();return(i=this.renderOptions).renderBefore??(i.renderBefore=e.firstChild),e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=xt(i,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return E}};var We;h._$litElement$=!0,h.finalized=!0,(We=j.litElementHydrateSupport)==null||We.call(j,{LitElement:h});const ve=j.litElementPolyfillSupport;ve==null||ve({LitElement:h});(j.litElementVersions??(j.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 ...
 */class be extends jt{constructor(e){if(super(e),this.it=u,e.type!==Ct.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===u||e==null)return this._t=void 0,this.it=e;if(e===E)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}be.directiveName="unsafeHTML",be.resultType=1;const y=Pt(be),Ot=`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,Et=`<svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
...
</svg>`;var Gt=Object.defineProperty,qt=Object.getOwnPropertyDescriptor,_e=(r,e,i,s)=>{for(var t=s>1?void 0:s?qt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Gt(e,i,t),t};let F=class extends h{constructor(){super(...arguments),this.lang="en",this.data={brand:"Trio-Soft",nav:[],getStarted:"Get Started"}}render(){const r="#/language",e=this.lang==="jp"?"#/jp/":"#/";return this.lang,p`
      <header class="header">
        <div class="header-brand">
          <div class="header-logo">${y(Ot)}</div>
        ...
        <div class="header-right">
          ...
          <div class="header-actions">
            <a class="header-lang-btn" href="${r}" title="Change language">${y(Et)}</a>
          </div>
        </div>
      </header>
    `}};F.styles=f`
  ...
  `;_e([n({type:String})],F.prototype,"lang",2);_e([n({type:Object})],F.prototype,"data",2);F=_e([m("trio-header")],F);var Ft=Object.defineProperty,Yt=Object.getOwnPropertyDescriptor,Ae=(r,e,i,s)=>{for(var t=s>1?void 0:s?Yt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Ft(e,i,t),t};let Y=class extends h{constructor(){super(...arguments),this.lang="en",this.data={privacyPolicy:"Privacy Policy",termsOfService:"Terms of Service",copyright:"© 2025 Trio-Soft. All rights reserved."}}render(){const r=this.lang==="jp"?"#/jp/privacy":"#/privacy",e=this.lang==="jp"?"#/jp/terms":"#/terms";return p`
  ...
  `;Ae([n({type:String})],Y.prototype,"lang",2);Ae([n({type:Object})],Y.prototype,"data",2);Y=Ae([m("trio-footer")],Y);var Kt=Object.defineProperty,Jt=Object.getOwnPropertyDescriptor,Z=(r,e,i,s)=>{for(var t=s>1?void 0:s?Jt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Kt(e,i,t),t};let A=class extends h{constructor(){super(...arguments),this.title="",this.subtitle="",this.buttonText="",this.buttonHref="",this.backgroundImage="/hero-en.jpg"}render(){return p`
  ...
  `;Z([n({type:String})],A.prototype,"title",2);Z([n({type:String})],A.prototype,"subtitle",2);Z([n({type:String})],A.prototype,"buttonText",2);Z([n({type:String})],A.prototype,"buttonHref",2);Z([n({type:String})],A.prototype,"backgroundImage",2);A=Z([m("trio-hero")],A);var kt=Object.defineProperty,Qt=Object.getOwnPropertyDescriptor,he=(r,e,i,s)=>{for(var t=s>1?void 0:s?Qt(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&kt(e,i,t),t};const Ne={gear:Ht,"app-window":Mt,robot:zt,"presentation-chart":Lt,cloud:Dt,lightbulb:Je,globe:It,"device-mobile":Zt,code:Vt,video:Bt,"chart-line":Ut,headset:Rt,users:ke,briefcase:Nt,"list-checks":Wt,user:Qe,rocket:Xe};function Xt(r){return Ne[r]||Ne.gear}let D=class extends h{constructor(){super(...arguments),this.icon="gear",this.title="",this.description=""}render(){return p`
      <div class="service-card">
        <div class="service-card-icon">${y(Xt(this.icon))}</div>
  ...
  `;he([n({type:String})],D.prototype,"icon",2);he([n({type:String})],D.prototype,"title",2);he([n({type:String})],D.prototype,"description",2);D=he([m("trio-service-card")],D);var ei=Object.defineProperty,ti=Object.getOwnPropertyDescriptor,et=(r,e,i,s)=>{for(var t=s>1?void 0:s?ti(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&ei(e,i,t),t};let le=class extends h{constructor(){super(...arguments),this.services=[]}render(){return p`
  ...
  `;et([n({type:Array})],le.prototype,"services",2);le=et([m("trio-service-grid")],le);var ii=Object.defineProperty,si=Object.getOwnPropertyDescriptor,M=(r,e,i,s)=>{for(var t=s>1?void 0:s?si(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&ii(e,i,t),t};let x=class extends h{constructor(){super(...arguments),this.image="",this.title="",this.description="",this.client="",this.horizontal=!1,this.lang="en"}render(){const r=this.lang==="jp"?"#/jp/cases":"#/cases";return p`
  ...
  `;M([n({type:String})],x.prototype,"image",2);M([n({type:String})],x.prototype,"title",2);M([n({type:String})],x.prototype,"description",2);M([n({type:String})],x.prototype,"client",2);M([n({type:Boolean})],x.prototype,"horizontal",2);M([n({type:String})],x.prototype,"lang",2);x=M([m("trio-case-card")],x);var ri=Object.defineProperty,ai=Object.getOwnPropertyDescriptor,ge=(r,e,i,s)=>{for(var t=s>1?void 0:s?ai(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&ri(e,i,t),t};let I=class extends h{constructor(){super(...arguments),this.cases=[],this.scrollable=!1,this.lang="en"}render(){const r=!this.scrollable,e=this.scrollable?"case-list-scrollable":"case-list-vertical";return p`
      <div class="${e}">
  ...
  `;ge([n({type:Array})],I.prototype,"cases",2);ge([n({type:Boolean})],I.prototype,"scrollable",2);ge([n({type:String})],I.prototype,"lang",2);I=ge([m("trio-case-list")],I);var oi=Object.defineProperty,ni=Object.getOwnPropertyDescriptor,se=(r,e,i,s)=>{for(var t=s>1?void 0:s?ni(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&oi(e,i,t),t};let H=class extends h{constructor(){super(...arguments),this.category="",this.title="",this.description="",this.image=""}render(){return p`<div class="news-item"><div class="news-item-text"><p class="news-item-category">${this.category}</p><p class="news-item-title">${this.title}</p><p class="news-item-description">${this.description}</p></div><div class="news-item-image-wrap"><img class="news-item-image" src="${this.image}" alt="${this.title}" /></div></div>`}};H.styles=f`
    :host { display: block; }
  ...
  `;se([n({type:String})],H.prototype,"category",2);se([n({type:String})],H.prototype,"title",2);se([n({type:String})],H.prototype,"description",2);se([n({type:String})],H.prototype,"image",2);H=se([m("trio-news-item")],H);var li=Object.defineProperty,ci=Object.getOwnPropertyDescriptor,V=(r,e,i,s)=>{for(var t=s>1?void 0:s?ci(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&li(e,i,t),t};let S=class extends h{constructor(){super(...arguments),this.title="",this.subtitle="",this.buttonText="",this.buttonHref="",this.lang="en"}render(){const r=this.buttonHref||(this.lang==="jp"?"#/jp/contact":"#/contact");return p`
      <div class="cta-wrap">
        <div class="cta-box">
          <div class="cta-text">
  ...
  `;V([n({type:String})],S.prototype,"title",2);V([n({type:String})],S.prototype,"subtitle",2);V([n({type:String})],S.prototype,"buttonText",2);V([n({type:String})],S.prototype,"buttonHref",2);V([n({type:String})],S.prototype,"lang",2);S=V([m("trio-cta-section")],S);var pi=Object.defineProperty,di=Object.getOwnPropertyDescriptor,Se=(r,e,i,s)=>{for(var t=s>1?void 0:s?di(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&pi(e,i,t),t};let K=class extends h{constructor(){super(...arguments),this.data={},this.lang="en"}render(){const r=this.data;if(!r)return p`<div>Loading...</div>`;const e=this.lang==="jp"?"#/jp/services":"#/services",i=this.lang==="jp"?"#/jp/contact":"#/contact",s=this.lang==="jp"?"/hero-jp.jpg":"/hero-en.jpg";return p`
  ...
  `;Se([n({type:Object})],K.prototype,"data",2);Se([n({type:String})],K.prototype,"lang",2);K=Se([m("page-home")],K);var hi=Object.defineProperty,gi=Object.getOwnPropertyDescriptor,Te=(r,e,i,s)=>{for(var t=s>1?void 0:s?gi(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&hi(e,i,t),t};let J=class extends h{constructor(){super(...arguments),this.data={},this.lang="en"}render(){const r=this.data;if(!r)return p`<div>Loading...</div>`;const e=this.lang==="jp"?"#/jp/contact":"#/contact";return p`<div class="page-head"><div class="page-head-box"><p class="page-title">${r.pageTitle}</p><p class="page-subtitle">${r.pageSubtitle}</p></div></div>${r.sections.map(i=>p`<h2 class="section-title">${i.title}</h2><div class="grid-wrap"><trio-service-grid .services=${i.cards}></trio-service-grid></div>`)}<trio-cta-section .title=${r.ctaTitle} .subtitle=${r.ctaSubtitle} .buttonText=${r.ctaButton} .buttonHref=${e} tone="blue"></trio-cta-section>`}};J.styles=f`
    :host { display: block; }
  ...
  `;Te([n({type:Object})],J.prototype,"data",2);Te([n({type:String})],J.prototype,"lang",2);J=Te([m("page-services")],J);var ui=Object.defineProperty,fi=Object.getOwnPropertyDescriptor,Ce=(r,e,i,s)=>{for(var t=s>1?void 0:s?fi(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&ui(e,i,t),t};let k=class extends h{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return p`
      <div class="container">
  ...
  `;Ce([n({type:String})],k.prototype,"lang",2);Ce([n({type:Object})],k.prototype,"data",2);k=Ce([m("page-cases")],k);var mi=Object.defineProperty,vi=Object.getOwnPropertyDescriptor,Pe=(r,e,i,s)=>{for(var t=s>1?void 0:s?vi(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&mi(e,i,t),t};let Q=class extends h{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return p`
      <div class="container">
        <div class="header-section">
          <h1 class="page-title">${this.data.pageTitle}</h1>
        </div>
  ...
  `;Pe([n({type:String})],Q.prototype,"lang",2);Pe([n({type:Object})],Q.prototype,"data",2);Q=Pe([m("page-about")],Q);var bi=Object.defineProperty,yi=Object.getOwnPropertyDescriptor,B=(r,e,i,s)=>{for(var t=s>1?void 0:s?yi(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&bi(e,i,t),t};const xi="https://formspree.io/f/mreyloqo";let T=class extends h{constructor(){super(...arguments),this.lang="en",this.data={},this._status="idle",this._errorMessage=""}async _handleSubmit(r){r.preventDefault(),this._status="submitting",this._errorMessage="";const e=new FormData(this._form);try{const i=await fetch(xi,{method:"POST",body:e,headers:{Accept:"application/json"}});if(i.ok)this._status="success",this._form.reset();else{const s=await i.json();s.errors?this._errorMessage=s.errors.map(t=>t.message).join(", "):this._errorMessage=this.lang==="jp"?"フォームの送信中に問題が発生しました。":"Oops! There was a problem submitting your form.",this._status="error"}}catch{this._errorMessage=this.lang==="jp"?"フォームの送信中に問題が発生しました。":"Oops! There was a problem submitting your form.",this._status="error"}}_renderStatusMessage(){if(this._status==="success"){const r=this.lang==="jp"?"お問い合わせありがとうございます！":"Thanks for your submission!";return p`<p class="status-message status-success">${r}</p>`}return this._status==="error"?p`<p class="status-message status-error">${this._errorMessage}</p>`:""}render(){const r=this._status==="submitting";return p`
      <div class="container">
        <div class="header-section">
          <div class="title-group">
            <h1 class="page-title">${this.data.pageTitle}</h1>
  ...
  `;B([n({type:String})],T.prototype,"lang",2);B([n({type:Object})],T.prototype,"data",2);B([de()],T.prototype,"_status",2);B([de()],T.prototype,"_errorMessage",2);B([At("form")],T.prototype,"_form",2);T=B([m("page-contact")],T);var wi=Object.defineProperty,$i=Object.getOwnPropertyDescriptor,je=(r,e,i,s)=>{for(var t=s>1?void 0:s?$i(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&wi(e,i,t),t};let X=class extends h{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return p`
      <div class="container">
        <h1 class="page-title">${this.data.pageTitle}</h1>
        <div class="content">
          ${y(this.data.content)}
  ...
  `;je([n({type:String})],X.prototype,"lang",2);je([n({type:Object})],X.prototype,"data",2);X=je([m("page-privacy")],X);var _i=Object.defineProperty,Ai=Object.getOwnPropertyDescriptor,Oe=(r,e,i,s)=>{for(var t=s>1?void 0:s?Ai(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&_i(e,i,t),t};let ee=class extends h{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return p`
      <div class="container">
        <h1 class="page-title">${this.data.pageTitle}</h1>
        <div class="content">
          ${y(this.data.content)}
  ...
  `;Oe([n({type:String})],ee.prototype,"lang",2);Oe([n({type:Object})],ee.prototype,"data",2);ee=Oe([m("page-terms")],ee);var Si=Object.defineProperty,Ti=Object.getOwnPropertyDescriptor,tt=(r,e,i,s)=>{for(var t=s>1?void 0:s?Ti(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Si(e,i,t),t};let ce=class extends h{constructor(){super(...arguments),this.data={}}render(){return p`
      <div class="wrapper">
        <div class="content">
          <div class="header">
  ...
  `;tt([n({type:Object})],ce.prototype,"data",2);ce=tt([m("trio-language-selector")],ce);var Ci=Object.defineProperty,Pi=Object.getOwnPropertyDescriptor,Ee=(r,e,i,s)=>{for(var t=s>1?void 0:s?Pi(e,i):e,a=r.length-1,o;a>=0;a--)(o=r[a])&&(t=(s?o(e,i,t):o(t))||t);return s&&t&&Ci(e,i,t),t};let te=class extends h{constructor(){super(),this.route=window.location.hash||"#/",this.lang=this.route.startsWith("#/jp")?"jp":"en",window.addEventListener("hashchange",()=>{this.route=window.location.hash||"#/",this.lang=this.route.startsWith("#/jp")?"jp":"en",window.scrollTo(0,0)})}render(){const r=this.lang==="jp"?Tt:St;return p`
  ...
  `;Ee([de()],te.prototype,"route",2);Ee([de()],te.prototype,"lang",2);te=Ee([m("trio-app")],te);
