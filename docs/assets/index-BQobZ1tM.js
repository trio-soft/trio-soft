 ...
 */const oe=globalThis,we=oe.ShadowRoot&&(oe.ShadyCSS===void 0||oe.ShadyCSS.nativeShadow)&&"adoptedStyleSheets"in Document.prototype&&"replace"in CSSStyleSheet.prototype,$e=Symbol(),De=new WeakMap;let Qe=class{constructor(e,i,s){if(this._$cssResult$=!0,s!==$e)throw Error("CSSResult is not constructable. Use `unsafeCSS` or `css` instead.");this.cssText=e,this.t=i}get styleSheet(){let e=this.o;const i=this.t;if(we&&e===void 0){const s=i!==void 0&&i.length===1;s&&(e=De.get(i)),e===void 0&&((this.o=e=new CSSStyleSheet).replaceSync(this.cssText),s&&De.set(i,e))}return e}toString(){return this.cssText}};const ct=r=>new Qe(typeof r=="string"?r:r+"",void 0,$e),f=(r,...e)=>{const i=r.length===1?r[0]:e.reduce((s,t,o)=>s+(a=>{if(a._$cssResult$===!0)return a.cssText;if(typeof a=="number")return a;throw Error("Value passed to 'css' function must be a 'css' function result: "+a+". Use 'unsafeCSS' to pass non-literal values, but take care to ensure page security.")})(t)+r[o+1],r[0]);return new Qe(i,r,$e)},pt=(r,e)=>{if(we)r.adoptedStyleSheets=e.map(i=>i instanceof CSSStyleSheet?i:i.styleSheet);else for(const i of e){const s=document.createElement("style"),t=oe.litNonce;t!==void 0&&s.setAttribute("nonce",t),s.textContent=i.cssText,r.appendChild(s)}},Ze=we?r=>r:r=>r instanceof CSSStyleSheet?(e=>{let i="";for(const s of e.cssRules)i+=s.cssText;return ct(i)})(r):r;/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const{is:dt,defineProperty:ht,getOwnPropertyDescriptor:gt,getOwnPropertyNames:ut,getOwnPropertySymbols:mt,getPrototypeOf:ft}=Object,_=globalThis,Ve=_.trustedTypes,vt=Ve?Ve.emptyScript:"",fe=_.reactiveElementPolyfillSupport,N=(r,e)=>r,ne={toAttribute(r,e){switch(e){case Boolean:r=r?vt:null;break;case Object:case Array:r=r==null?r:JSON.stringify(r)}return r},fromAttribute(r,e){let i=r;switch(e){case Boolean:i=r!==null;break;case Number:i=r===null?null:Number(r);break;case Object:case Array:try{i=JSON.parse(r)}catch{i=null}}return i}},_e=(r,e)=>!dt(r,e),Be={attribute:!0,type:String,converter:ne,reflect:!1,useDefault:!1,hasChanged:_e};Symbol.metadata??(Symbol.metadata=Symbol("metadata")),_.litPropertyMetadata??(_.litPropertyMetadata=new WeakMap);let z=class extends HTMLElement{static addInitializer(e){this._$Ei(),(this.l??(this.l=[])).push(e)}static get observedAttributes(){return this.finalize(),this._$Eh&&[...this._$Eh.keys()]}static createProperty(e,i=Be){if(i.state&&(i.attribute=!1),this._$Ei(),this.prototype.hasOwnProperty(e)&&((i=Object.create(i)).wrapped=!0),this.elementProperties.set(e,i),!i.noAccessor){const s=Symbol(),t=this.getPropertyDescriptor(e,s,i);t!==void 0&&ht(this.prototype,e,t)}}static getPropertyDescriptor(e,i,s){const{get:t,set:o}=gt(this.prototype,e)??{get(){return this[i]},set(a){this[i]=a}};return{get:t,set(a){const p=t==null?void 0:t.call(this);o==null||o.call(this,a),this.requestUpdate(e,p,s)},configurable:!0,enumerable:!0}}static getPropertyOptions(e){return this.elementProperties.get(e)??Be}static _$Ei(){if(this.hasOwnProperty(N("elementProperties")))return;const e=ft(this);e.finalize(),e.l!==void 0&&(this.l=[...e.l]),this.elementProperties=new Map(e.elementProperties)}static finalize(){if(this.hasOwnProperty(N("finalized")))return;if(this.finalized=!0,this._$Ei(),this.hasOwnProperty(N("properties"))){const i=this.properties,s=[...ut(i),...mt(i)];for(const t of s)this.createProperty(t,i[t])}const e=this[Symbol.metadata];if(e!==null){const i=litPropertyMetadata.get(e);if(i!==void 0)for(const[s,t]of i)this.elementProperties.set(s,t)}this._$Eh=new Map;for(const[i,s]of this.elementProperties){const t=this._$Eu(i,s);t!==void 0&&this._$Eh.set(t,i)}this.elementStyles=this.finalizeStyles(this.styles)}static finalizeStyles(e){const i=[];if(Array.isArray(e)){const s=new Set(e.flat(1/0).reverse());for(const t of s)i.unshift(Ze(t))}else e!==void 0&&i.push(Ze(e));return i}static _$Eu(e,i){const s=i.attribute;return s===!1?void 0:typeof s=="string"?s:typeof e=="string"?e.toLowerCase():void 0}constructor(){super(),this._$Ep=void 0,this.isUpdatePending=!1,this.hasUpdated=!1,this._$Em=null,this._$Ev()}_$Ev(){var e;this._$ES=new Promise(i=>this.enableUpdating=i),this._$AL=new Map,this._$E_(),this.requestUpdate(),(e=this.constructor.l)==null||e.forEach(i=>i(this))}addController(e){var i;(this._$EO??(this._$EO=new Set)).add(e),this.renderRoot!==void 0&&this.isConnected&&((i=e.hostConnected)==null||i.call(e))}removeController(e){var i;(i=this._$EO)==null||i.delete(e)}_$E_(){const e=new Map,i=this.constructor.elementProperties;for(const s of i.keys())this.hasOwnProperty(s)&&(e.set(s,this[s]),delete this[s]);e.size>0&&(this._$Ep=e)}createRenderRoot(){const e=this.shadowRoot??this.attachShadow(this.constructor.shadowRootOptions);return pt(e,this.constructor.elementStyles),e}connectedCallback(){var e;this.renderRoot??(this.renderRoot=this.createRenderRoot()),this.enableUpdating(!0),(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostConnected)==null?void 0:s.call(i)})}enableUpdating(e){}disconnectedCallback(){var e;(e=this._$EO)==null||e.forEach(i=>{var s;return(s=i.hostDisconnected)==null?void 0:s.call(i)})}attributeChangedCallback(e,i,s){this._$AK(e,s)}_$ET(e,i){var o;const s=this.constructor.elementProperties.get(e),t=this.constructor._$Eu(e,s);if(t!==void 0&&s.reflect===!0){const a=(((o=s.converter)==null?void 0:o.toAttribute)!==void 0?s.converter:ne).toAttribute(i,s.type);this._$Em=e,a==null?this.removeAttribute(t):this.setAttribute(t,a),this._$Em=null}}_$AK(e,i){var o,a;const s=this.constructor,t=s._$Eh.get(e);if(t!==void 0&&this._$Em!==t){const p=s.getPropertyOptions(t),c=typeof p.converter=="function"?{fromAttribute:p.converter}:((o=p.converter)==null?void 0:o.fromAttribute)!==void 0?p.converter:ne;this._$Em=t;const d=c.fromAttribute(i,p.type);this[t]=d??((a=this._$Ej)==null?void 0:a.get(t))??d,this._$Em=null}}requestUpdate(e,i,s,t=!1,o){var a;if(e!==void 0){const p=this.constructor;if(t===!1&&(o=this[e]),s??(s=p.getPropertyOptions(e)),!((s.hasChanged??_e)(o,i)||s.useDefault&&s.reflect&&o===((a=this._$Ej)==null?void 0:a.get(e))&&!this.hasAttribute(p._$Eu(e,s))))return;this.C(e,i,s)}this.isUpdatePending===!1&&(this._$ES=this._$EP())}C(e,i,{useDefault:s,reflect:t,wrapped:o},a){s&&!(this._$Ej??(this._$Ej=new Map)).has(e)&&(this._$Ej.set(e,a??i??this[e]),o!==!0||a!==void 0)||(this._$AL.has(e)||(this.hasUpdated||s||(i=void 0),this._$AL.set(e,i)),t===!0&&this._$Em!==e&&(this._$Eq??(this._$Eq=new Set)).add(e))}async _$EP(){this.isUpdatePending=!0;try{await this._$ES}catch(i){Promise.reject(i)}const e=this.scheduleUpdate();return e!=null&&await e,!this.isUpdatePending}scheduleUpdate(){return this.performUpdate()}performUpdate(){var s;if(!this.isUpdatePending)return;if(!this.hasUpdated){if(this.renderRoot??(this.renderRoot=this.createRenderRoot()),this._$Ep){for(const[o,a]of this._$Ep)this[o]=a;this._$Ep=void 0}const t=this.constructor.elementProperties;if(t.size>0)for(const[o,a]of t){const{wrapped:p}=a,c=this[o];p!==!0||this._$AL.has(o)||c===void 0||this.C(o,void 0,a,c)}}let e=!1;const i=this._$AL;try{e=this.shouldUpdate(i),e?(this.willUpdate(i),(s=this._$EO)==null||s.forEach(t=>{var o;return(o=t.hostUpdate)==null?void 0:o.call(t)}),this.update(i)):this._$EM()}catch(t){throw e=!1,this._$EM(),t}e&&this._$AE(i)}willUpdate(e){}_$AE(e){var i;(i=this._$EO)==null||i.forEach(s=>{var t;return(t=s.hostUpdated)==null?void 0:t.call(s)}),this.hasUpdated||(this.hasUpdated=!0,this.firstUpdated(e)),this.updated(e)}_$EM(){this._$AL=new Map,this.isUpdatePending=!1}get updateComplete(){return this.getUpdateComplete()}getUpdateComplete(){return this._$ES}shouldUpdate(e){return!0}update(e){this._$Eq&&(this._$Eq=this._$Eq.forEach(i=>this._$ET(i,this[i]))),this._$EM()}updated(e){}firstUpdated(e){}};z.elementStyles=[],z.shadowRootOptions={mode:"open"},z[N("elementProperties")]=new Map,z[N("finalized")]=new Map,fe==null||fe({ReactiveElement:z}),(_.reactiveElementVersions??(_.reactiveElementVersions=[])).push("2.1.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const U=globalThis,Re=r=>r,le=U.trustedTypes,Ne=le?le.createPolicy("lit-html",{createHTML:r=>r}):void 0,Xe="$lit$",$=`lit$${Math.random().toFixed(9).slice(2)}$`,et="?"+$,bt=`<${et}>`,O=document,W=()=>O.createComment(""),G=r=>r===null||typeof r!="object"&&typeof r!="function",Ae=Array.isArray,yt=r=>Ae(r)||typeof(r==null?void 0:r[Symbol.iterator])=="function",ve=`[ 	
\f\r]`,R=/<(?:(!--|\/[^a-zA-Z])|(\/?[a-zA-Z][^>\s]*)|(\/?$))/g,Ue=/-->/g,We=/>/g,j=RegExp(`>|${ve}(?:([^\\s"'>=/]+)(${ve}*=${ve}*(?:[^ 	
\f\r"'\`<>=]|("|')|))|$)`,"g"),Ge=/'/g,qe=/"/g,tt=/^(?:script|style|textarea|title)$/i,xt=r=>(e,...i)=>({_$litType$:r,strings:e,values:i}),n=xt(1),E=Symbol.for("lit-noChange"),m=Symbol.for("lit-nothing"),ke=new WeakMap,C=O.createTreeWalker(O,129);function it(r,e){if(!Ae(r)||!r.hasOwnProperty("raw"))throw Error("invalid template strings array");return Ne!==void 0?Ne.createHTML(e):e}const wt=(r,e)=>{const i=r.length-1,s=[];let t,o=e===2?"<svg>":e===3?"<math>":"",a=R;for(let p=0;p<i;p++){const c=r[p];let d,u,h=-1,y=0;for(;y<c.length&&(a.lastIndex=y,u=a.exec(c),u!==null);)y=a.lastIndex,a===R?u[1]==="!--"?a=Ue:u[1]!==void 0?a=We:u[2]!==void 0?(tt.test(u[2])&&(t=RegExp("</"+u[2],"g")),a=j):u[3]!==void 0&&(a=j):a===j?u[0]===">"?(a=t??R,h=-1):u[1]===void 0?h=-2:(h=a.lastIndex-u[2].length,d=u[1],a=u[3]===void 0?j:u[3]==='"'?qe:Ge):a===qe||a===Ge?a=j:a===Ue||a===We?a=R:(a=j,t=void 0);const w=a===j&&r[p+1].startsWith("/>")?" ":"";o+=a===R?c+bt:h>=0?(s.push(d),c.slice(0,h)+Xe+c.slice(h)+$+w):c+$+(h===-2?p:w)}return[it(r,o+(r[i]||"<?>")+(e===2?"</svg>":e===3?"</math>":"")),s]};class q{constructor({strings:e,_$litType$:i},s){let t;this.parts=[];let o=0,a=0;const p=e.length-1,c=this.parts,[d,u]=wt(e,i);if(this.el=q.createElement(d,s),C.currentNode=this.el.content,i===2||i===3){const h=this.el.content.firstChild;h.replaceWith(...h.childNodes)}for(;(t=C.nextNode())!==null&&c.length<p;){if(t.nodeType===1){if(t.hasAttributes())for(const h of t.getAttributeNames())if(h.endsWith(Xe)){const y=u[a++],w=t.getAttribute(h).split($),ae=/([.?@])?(.*)/.exec(y);c.push({type:1,index:o,name:ae[2],strings:w,ctor:ae[1]==="."?_t:ae[1]==="?"?At:ae[1]==="@"?St:de}),t.removeAttribute(h)}else h.startsWith($)&&(c.push({type:6,index:o}),t.removeAttribute(h));if(tt.test(t.tagName)){const h=t.textContent.split($),y=h.length-1;if(y>0){t.textContent=le?le.emptyScript:"";for(let w=0;w<y;w++)t.append(h[w],W()),C.nextNode(),c.push({type:2,index:++o});t.append(h[y],W())}}}else if(t.nodeType===8)if(t.data===et)c.push({type:2,index:o});else{let h=-1;for(;(h=t.data.indexOf($,h+1))!==-1;)c.push({type:7,index:o}),h+=$.length-1}o++}}static createElement(e,i){const s=O.createElement("template");return s.innerHTML=e,s}}function L(r,e,i=r,s){var a,p;if(e===E)return e;let t=s!==void 0?(a=i._$Co)==null?void 0:a[s]:i._$Cl;const o=G(e)?void 0:e._$litDirective$;return(t==null?void 0:t.constructor)!==o&&((p=t==null?void 0:t._$AO)==null||p.call(t,!1),o===void 0?t=void 0:(t=new o(r),t._$AT(r,i,s)),s!==void 0?(i._$Co??(i._$Co=[]))[s]=t:i._$Cl=t),t!==void 0&&(e=L(r,t._$AS(r,e.values),t,s)),e}class $t{constructor(e,i){this._$AV=[],this._$AN=void 0,this._$AD=e,this._$AM=i}get parentNode(){return this._$AM.parentNode}get _$AU(){return this._$AM._$AU}u(e){const{el:{content:i},parts:s}=this._$AD,t=((e==null?void 0:e.creationScope)??O).importNode(i,!0);C.currentNode=t;let o=C.nextNode(),a=0,p=0,c=s[0];for(;c!==void 0;){if(a===c.index){let d;c.type===2?d=new se(o,o.nextSibling,this,e):c.type===1?d=new c.ctor(o,c.name,c.strings,this,e):c.type===6&&(d=new Tt(o,this,e)),this._$AV.push(d),c=s[++p]}a!==(c==null?void 0:c.index)&&(o=C.nextNode(),a++)}return C.currentNode=O,t}p(e){let i=0;for(const s of this._$AV)s!==void 0&&(s.strings!==void 0?(s._$AI(e,s,i),i+=s.strings.length-2):s._$AI(e[i])),i++}}class se{get _$AU(){var e;return((e=this._$AM)==null?void 0:e._$AU)??this._$Cv}constructor(e,i,s,t){this.type=2,this._$AH=m,this._$AN=void 0,this._$AA=e,this._$AB=i,this._$AM=s,this.options=t,this._$Cv=(t==null?void 0:t.isConnected)??!0}get parentNode(){let e=this._$AA.parentNode;const i=this._$AM;return i!==void 0&&(e==null?void 0:e.nodeType)===11&&(e=i.parentNode),e}get startNode(){return this._$AA}get endNode(){return this._$AB}_$AI(e,i=this){e=L(this,e,i),G(e)?e===m||e==null||e===""?(this._$AH!==m&&this._$AR(),this._$AH=m):e!==this._$AH&&e!==E&&this._(e):e._$litType$!==void 0?this.$(e):e.nodeType!==void 0?this.T(e):yt(e)?this.k(e):this._(e)}O(e){return this._$AA.parentNode.insertBefore(e,this._$AB)}T(e){this._$AH!==e&&(this._$AR(),this._$AH=this.O(e))}_(e){this._$AH!==m&&G(this._$AH)?this._$AA.nextSibling.data=e:this.T(O.createTextNode(e)),this._$AH=e}$(e){var o;const{values:i,_$litType$:s}=e,t=typeof s=="number"?this._$AC(e):(s.el===void 0&&(s.el=q.createElement(it(s.h,s.h[0]),this.options)),s);if(((o=this._$AH)==null?void 0:o._$AD)===t)this._$AH.p(i);else{const a=new $t(t,this),p=a.u(this.options);a.p(i),this.T(p),this._$AH=a}}_$AC(e){let i=ke.get(e.strings);return i===void 0&&ke.set(e.strings,i=new q(e)),i}k(e){Ae(this._$AH)||(this._$AH=[],this._$AR());const i=this._$AH;let s,t=0;for(const o of e)t===i.length?i.push(s=new se(this.O(W()),this.O(W()),this,this.options)):s=i[t],s._$AI(o),t++;t<i.length&&(this._$AR(s&&s._$AB.nextSibling,t),i.length=t)}_$AR(e=this._$AA.nextSibling,i){var s;for((s=this._$AP)==null?void 0:s.call(this,!1,!0,i);e!==this._$AB;){const t=Re(e).nextSibling;Re(e).remove(),e=t}}setConnected(e){var i;this._$AM===void 0&&(this._$Cv=e,(i=this._$AP)==null||i.call(this,e))}}class de{get tagName(){return this.element.tagName}get _$AU(){return this._$AM._$AU}constructor(e,i,s,t,o){this.type=1,this._$AH=m,this._$AN=void 0,this.element=e,this.name=i,this._$AM=t,this.options=o,s.length>2||s[0]!==""||s[1]!==""?(this._$AH=Array(s.length-1).fill(new String),this.strings=s):this._$AH=m}_$AI(e,i=this,s,t){const o=this.strings;let a=!1;if(o===void 0)e=L(this,e,i,0),a=!G(e)||e!==this._$AH&&e!==E,a&&(this._$AH=e);else{const p=e;let c,d;for(e=o[0],c=0;c<o.length-1;c++)d=L(this,p[s+c],i,c),d===E&&(d=this._$AH[c]),a||(a=!G(d)||d!==this._$AH[c]),d===m?e=m:e!==m&&(e+=(d??"")+o[c+1]),this._$AH[c]=d}a&&!t&&this.j(e)}j(e){e===m?this.element.removeAttribute(this.name):this.element.setAttribute(this.name,e??"")}}class _t extends de{constructor(){super(...arguments),this.type=3}j(e){this.element[this.name]=e===m?void 0:e}}class At extends de{constructor(){super(...arguments),this.type=4}j(e){this.element.toggleAttribute(this.name,!!e&&e!==m)}}class St extends de{constructor(e,i,s,t,o){super(e,i,s,t,o),this.type=5}_$AI(e,i=this){if((e=L(this,e,i,0)??m)===E)return;const s=this._$AH,t=e===m&&s!==m||e.capture!==s.capture||e.once!==s.once||e.passive!==s.passive,o=e!==m&&(s===m||t);t&&this.element.removeEventListener(this.name,this,s),o&&this.element.addEventListener(this.name,this,e),this._$AH=e}handleEvent(e){var i;typeof this._$AH=="function"?this._$AH.call(((i=this.options)==null?void 0:i.host)??this.element,e):this._$AH.handleEvent(e)}}class Tt{constructor(e,i,s){this.element=e,this.type=6,this._$AN=void 0,this._$AM=i,this.options=s}get _$AU(){return this._$AM._$AU}_$AI(e){L(this,e)}}const be=U.litHtmlPolyfillSupport;be==null||be(q,se),(U.litHtmlVersions??(U.litHtmlVersions=[])).push("3.3.2");const jt=(r,e,i)=>{const s=(i==null?void 0:i.renderBefore)??e;let t=s._$litPart$;if(t===void 0){const o=(i==null?void 0:i.renderBefore)??null;s._$litPart$=t=new se(e.insertBefore(W(),o),o,void 0,i??{})}return t._$AI(r),t};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const P=globalThis;let g=class extends z{constructor(){super(...arguments),this.renderOptions={host:this},this._$Do=void 0}createRenderRoot(){var i;const e=super.createRenderRoot();return(i=this.renderOptions).renderBefore??(i.renderBefore=e.firstChild),e}update(e){const i=this.render();this.hasUpdated||(this.renderOptions.isConnected=this.isConnected),super.update(e),this._$Do=jt(i,this.renderRoot,this.renderOptions)}connectedCallback(){var e;super.connectedCallback(),(e=this._$Do)==null||e.setConnected(!0)}disconnectedCallback(){var e;super.disconnectedCallback(),(e=this._$Do)==null||e.setConnected(!1)}render(){return E}};var Ke;g._$litElement$=!0,g.finalized=!0,(Ke=P.litElementHydrateSupport)==null||Ke.call(P,{LitElement:g});const ye=P.litElementPolyfillSupport;ye==null||ye({LitElement:g});(P.litElementVersions??(P.litElementVersions=[])).push("4.2.2");/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const v=r=>(e,i)=>{i!==void 0?i.addInitializer(()=>{customElements.define(r,e)}):customElements.define(r,e)};/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ct={attribute:!0,type:String,converter:ne,reflect:!1,hasChanged:_e},Pt=(r=Ct,e,i)=>{const{kind:s,metadata:t}=i;let o=globalThis.litPropertyMetadata.get(t);if(o===void 0&&globalThis.litPropertyMetadata.set(t,o=new Map),s==="setter"&&((r=Object.create(r)).wrapped=!0),o.set(i.name,r),s==="accessor"){const{name:a}=i;return{set(p){const c=e.get.call(this);e.set.call(this,p),this.requestUpdate(a,c,r,!0,p)},init(p){return p!==void 0&&this.C(a,void 0,r,p),p}}}if(s==="setter"){const{name:a}=i;return function(p){const c=this[a];e.call(this,p),this.requestUpdate(a,c,r,!0,p)}}throw Error("Unsupported decorator location: "+s)};function l(r){return(e,i)=>typeof i=="object"?Pt(r,e,i):((s,t,o)=>{const a=t.hasOwnProperty(o);return t.constructor.createProperty(o,s),a?Object.getOwnPropertyDescriptor(t,o):void 0})(r,e,i)}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function he(r){return l({...r,state:!0,attribute:!1})}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Ot=(r,e,i)=>(i.configurable=!0,i.enumerable=!0,Reflect.decorate&&typeof e!="object"&&Object.defineProperty(r,e,i),i);/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */function Et(r,e){return(i,s,t)=>{const o=a=>{var p;return((p=a.renderRoot)==null?void 0:p.querySelector(r))??null};return Ot(i,s,{get(){return o(this)}})}}const Ht={brand:"Trio-Soft",nav:[{label:"Services",href:"#/services"},{label:"Our Work",href:"#/cases"},{label:"About Us",href:"#/about"},{label:"Contact",href:"#/contact"},{label:"Careers",href:"#/careers"}],getStarted:"Get Started",footer:{privacyPolicy:"Privacy Policy",termsOfService:"Terms of Service",copyright:"© 2025 Trio-Soft. All rights reserved."},privacy:{pageTitle:"Privacy Policy",content:`
 ...
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const zt={CHILD:2},Lt=r=>(...e)=>({_$litDirective$:r,values:e});class It{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,i,s){this._$Ct=e,this._$AM=i,this._$Ci=s}_$AS(e,i){return this.update(e,i)}update(e,i){return this.render(...i)}}/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */class xe extends It{constructor(e){if(super(e),this.it=m,e.type!==zt.CHILD)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(e){if(e===m||e==null)return this._t=void 0,this.it=e;if(e===E)return e;if(typeof e!="string")throw Error(this.constructor.directiveName+"() called with a non-string value");if(e===this.it)return this._t;this.it=e;const i=[e];return i.raw=i,this._t={_$litType$:this.constructor.resultType,strings:i,values:[]}}}xe.directiveName="unsafeHTML",xe.resultType=1;const b=Lt(xe),Dt=`<svg viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
...
</svg>`,Zt=`<svg xmlns="http://www.w3.org/2000/svg" width="20px" height="20px" fill="currentColor" viewBox="0 0 256 256">
...
</svg>`,Se=`<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" fill="currentColor" viewBox="0 0 256 256">
...
</svg>`;var Yt=Object.defineProperty,Kt=Object.getOwnPropertyDescriptor,je=(r,e,i,s)=>{for(var t=s>1?void 0:s?Kt(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&Yt(e,i,t),t};let k=class extends g{constructor(){super(...arguments),this.lang="en",this.data={brand:"Trio-Soft",nav:[],getStarted:"Get Started"}}render(){const r="#/language",e=this.lang==="jp"?"#/jp/":"#/";return this.lang,n`
      <header class="header">
        <div class="header-brand">
          <div class="header-logo">${b(Dt)}</div>
        ...
        <div class="header-right">
          ...
          <div class="header-actions">
            <a class="header-lang-btn" href="${r}" title="Change language">${b(Zt)}</a>
          </div>
        </div>
      </header>
    `}};k.styles=f`
  ...
  `;je([l({type:String})],k.prototype,"lang",2);je([l({type:Object})],k.prototype,"data",2);k=je([v("trio-header")],k);var Qt=Object.defineProperty,Xt=Object.getOwnPropertyDescriptor,Ce=(r,e,i,s)=>{for(var t=s>1?void 0:s?Xt(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&Qt(e,i,t),t};let F=class extends g{constructor(){super(...arguments),this.lang="en",this.data={privacyPolicy:"Privacy Policy",termsOfService:"Terms of Service",copyright:"© 2025 Trio-Soft. All rights reserved."}}render(){const r=this.lang==="jp"?"#/jp/privacy":"#/privacy",e=this.lang==="jp"?"#/jp/terms":"#/terms";return n`
  ...
  `;Ce([l({type:String})],F.prototype,"lang",2);Ce([l({type:Object})],F.prototype,"data",2);F=Ce([v("trio-footer")],F);var ei=Object.defineProperty,ti=Object.getOwnPropertyDescriptor,Z=(r,e,i,s)=>{for(var t=s>1?void 0:s?ti(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&ei(e,i,t),t};let A=class extends g{constructor(){super(...arguments),this.title="",this.subtitle="",this.buttonText="",this.buttonHref="",this.backgroundImage="/hero-en.jpg"}render(){return n`
  ...
  `;Z([l({type:String})],A.prototype,"title",2);Z([l({type:String})],A.prototype,"subtitle",2);Z([l({type:String})],A.prototype,"buttonText",2);Z([l({type:String})],A.prototype,"buttonHref",2);Z([l({type:String})],A.prototype,"backgroundImage",2);A=Z([v("trio-hero")],A);var ii=Object.defineProperty,si=Object.getOwnPropertyDescriptor,ue=(r,e,i,s)=>{for(var t=s>1?void 0:s?si(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&ii(e,i,t),t};const Fe={gear:st,"app-window":Vt,robot:Bt,"presentation-chart":Rt,cloud:Nt,lightbulb:Se,globe:rt,"device-mobile":Ut,code:Wt,video:Gt,"chart-line":qt,headset:kt,users:ge,briefcase:Ft,"list-checks":Jt,user:at,rocket:Te};function ri(r){return Fe[r]||Fe.gear}let I=class extends g{constructor(){super(...arguments),this.icon="gear",this.title="",this.description=""}render(){return n`
      <div class="service-card">
        <div class="service-card-icon">${b(ri(this.icon))}</div>
  ...
  `;ue([l({type:String})],I.prototype,"icon",2);ue([l({type:String})],I.prototype,"title",2);ue([l({type:String})],I.prototype,"description",2);I=ue([v("trio-service-card")],I);var ai=Object.defineProperty,oi=Object.getOwnPropertyDescriptor,ot=(r,e,i,s)=>{for(var t=s>1?void 0:s?oi(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&ai(e,i,t),t};let ce=class extends g{constructor(){super(...arguments),this.services=[]}render(){return n`
      <div class="service-grid">
        ${this.services.map(r=>n`
          <trio-service-card
            .icon="${r.icon}"
            .title="${r.title}"
  ...
  `;ot([l({type:Array})],ce.prototype,"services",2);ce=ot([v("trio-service-grid")],ce);var ni=Object.defineProperty,li=Object.getOwnPropertyDescriptor,M=(r,e,i,s)=>{for(var t=s>1?void 0:s?li(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&ni(e,i,t),t};let x=class extends g{constructor(){super(...arguments),this.image="",this.title="",this.description="",this.client="",this.horizontal=!1,this.lang="en"}render(){const r=this.lang==="jp"?"#/jp/cases":"#/cases";return n`
  ...
  `;M([l({type:String})],x.prototype,"image",2);M([l({type:String})],x.prototype,"title",2);M([l({type:String})],x.prototype,"description",2);M([l({type:String})],x.prototype,"client",2);M([l({type:Boolean})],x.prototype,"horizontal",2);M([l({type:String})],x.prototype,"lang",2);x=M([v("trio-case-card")],x);var ci=Object.defineProperty,pi=Object.getOwnPropertyDescriptor,me=(r,e,i,s)=>{for(var t=s>1?void 0:s?pi(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&ci(e,i,t),t};let D=class extends g{constructor(){super(...arguments),this.cases=[],this.scrollable=!1,this.lang="en"}render(){const r=!this.scrollable,e=this.scrollable?"case-list-scrollable":"case-list-vertical";return n`
      <div class="${e}">
  ...
  `;me([l({type:Array})],D.prototype,"cases",2);me([l({type:Boolean})],D.prototype,"scrollable",2);me([l({type:String})],D.prototype,"lang",2);D=me([v("trio-case-list")],D);var di=Object.defineProperty,hi=Object.getOwnPropertyDescriptor,re=(r,e,i,s)=>{for(var t=s>1?void 0:s?hi(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&di(e,i,t),t};let H=class extends g{constructor(){super(...arguments),this.category="",this.title="",this.description="",this.image=""}render(){return n`<div class="news-item"><div class="news-item-text"><p class="news-item-category">${this.category}</p><p class="news-item-title">${this.title}</p><p class="news-item-description">${this.description}</p></div><div class="news-item-image-wrap"><img class="news-item-image" src="${this.image}" alt="${this.title}" /></div></div>`}};H.styles=f`
    :host { display: block; }
  ...
  `;re([l({type:String})],H.prototype,"category",2);re([l({type:String})],H.prototype,"title",2);re([l({type:String})],H.prototype,"description",2);re([l({type:String})],H.prototype,"image",2);H=re([v("trio-news-item")],H);var gi=Object.defineProperty,ui=Object.getOwnPropertyDescriptor,V=(r,e,i,s)=>{for(var t=s>1?void 0:s?ui(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&gi(e,i,t),t};let S=class extends g{constructor(){super(...arguments),this.title="",this.subtitle="",this.buttonText="",this.buttonHref="",this.lang="en"}render(){const r=this.buttonHref||(this.lang==="jp"?"#/jp/contact":"#/contact");return n`
      <div class="cta-wrap">
        <div class="cta-box">
          <div class="cta-text">
  ...
  `;V([l({type:String})],S.prototype,"title",2);V([l({type:String})],S.prototype,"subtitle",2);V([l({type:String})],S.prototype,"buttonText",2);V([l({type:String})],S.prototype,"buttonHref",2);V([l({type:String})],S.prototype,"lang",2);S=V([v("trio-cta-section")],S);var mi=Object.defineProperty,fi=Object.getOwnPropertyDescriptor,Pe=(r,e,i,s)=>{for(var t=s>1?void 0:s?fi(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&mi(e,i,t),t};let J=class extends g{constructor(){super(...arguments),this.data={},this.lang="en"}render(){const r=this.data;if(!r)return n`<div>Loading...</div>`;const e=this.lang==="jp"?"#/jp/services":"#/services",i=this.lang==="jp"?"#/jp/contact":"#/contact",s=this.lang==="jp"?"/hero-jp.jpg":"/hero-en.jpg";return n`
      ...
      <div class="news-list">${r.news.map(t=>n`<trio-news-item .category=${t.category} .title=${t.title} .description=${t.description} .image=${t.image}></trio-news-item>`)}</div>
  ...
  `;Pe([l({type:Object})],J.prototype,"data",2);Pe([l({type:String})],J.prototype,"lang",2);J=Pe([v("page-home")],J);var vi=Object.defineProperty,bi=Object.getOwnPropertyDescriptor,Oe=(r,e,i,s)=>{for(var t=s>1?void 0:s?bi(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&vi(e,i,t),t};let Y=class extends g{constructor(){super(...arguments),this.data={},this.lang="en"}render(){const r=this.data;if(!r)return n`<div>Loading...</div>`;const e=this.lang==="jp"?"#/jp/contact":"#/contact";return n`<div class="page-head"><div class="page-head-box"><p class="page-title">${r.pageTitle}</p><p class="page-subtitle">${r.pageSubtitle}</p></div></div>${r.sections.map(i=>n`<h2 class="section-title">${i.title}</h2><div class="grid-wrap"><trio-service-grid .services=${i.cards}></trio-service-grid></div>`)}<trio-cta-section .title=${r.ctaTitle} .subtitle=${r.ctaSubtitle} .buttonText=${r.ctaButton} .buttonHref=${e} tone="blue"></trio-cta-section>`}};Y.styles=f`
    :host { display: block; }
  ...
  `;Oe([l({type:Object})],Y.prototype,"data",2);Oe([l({type:String})],Y.prototype,"lang",2);Y=Oe([v("page-services")],Y);var yi=Object.defineProperty,xi=Object.getOwnPropertyDescriptor,Ee=(r,e,i,s)=>{for(var t=s>1?void 0:s?xi(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&yi(e,i,t),t};let K=class extends g{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return n`
      <div class="container">
  ...
  `;Ee([l({type:String})],K.prototype,"lang",2);Ee([l({type:Object})],K.prototype,"data",2);K=Ee([v("page-cases")],K);var wi=Object.defineProperty,$i=Object.getOwnPropertyDescriptor,He=(r,e,i,s)=>{for(var t=s>1?void 0:s?$i(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&wi(e,i,t),t};let Q=class extends g{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return n`
      <div class="container">
        <div class="header-section">
          <h1 class="page-title">${this.data.pageTitle}</h1>
        </div>
        ...
        <div class="grid">
          ${this.data.team.map(r=>n`
            <div class="card">
              <div class="card-icon">${b(at)}</div>
        ...
        <div class="grid">
          ${this.data.values.map(r=>n`
            <div class="card">
              <div class="card-icon">
                <!-- Simple mapping for icons -->
                ${r.icon==="lightbulb"?b(Se):""}
                ${r.icon==="users"?b(ge):""}
                ${r.icon==="rocket"?b(Te):""}
              </div>
              <div class="title-group">
  ...
  `;He([l({type:String})],Q.prototype,"lang",2);He([l({type:Object})],Q.prototype,"data",2);Q=He([v("page-about")],Q);var _i=Object.defineProperty,Ai=Object.getOwnPropertyDescriptor,B=(r,e,i,s)=>{for(var t=s>1?void 0:s?Ai(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&_i(e,i,t),t};const Si="https://formspree.io/f/mreyloqo";let T=class extends g{constructor(){super(...arguments),this.lang="en",this.data={},this._status="idle",this._errorMessage=""}async _handleSubmit(r){r.preventDefault(),this._status="submitting",this._errorMessage="";const e=new FormData(this._form);try{const i=await fetch(Si,{method:"POST",body:e,headers:{Accept:"application/json"}});if(i.ok)this._status="success",this._form.reset();else{const s=await i.json();s.errors?this._errorMessage=s.errors.map(t=>t.message).join(", "):this._errorMessage=this.lang==="jp"?"フォームの送信中に問題が発生しました。":"Oops! There was a problem submitting your form.",this._status="error"}}catch{this._errorMessage=this.lang==="jp"?"フォームの送信中に問題が発生しました。":"Oops! There was a problem submitting your form.",this._status="error"}}_renderStatusMessage(){if(this._status==="success"){const r=this.lang==="jp"?"お問い合わせありがとうございます！":"Thanks for your submission!";return n`<p class="status-message status-success">${r}</p>`}return this._status==="error"?n`<p class="status-message status-error">${this._errorMessage}</p>`:""}render(){const r=this._status==="submitting";return n`
      <div class="container">
        <div class="header-section">
          <div class="title-group">
            <h1 class="page-title">${this.data.pageTitle}</h1>
  ...
  `;B([l({type:String})],T.prototype,"lang",2);B([l({type:Object})],T.prototype,"data",2);B([he()],T.prototype,"_status",2);B([he()],T.prototype,"_errorMessage",2);B([Et("form")],T.prototype,"_form",2);T=B([v("page-contact")],T);var Ti=Object.defineProperty,ji=Object.getOwnPropertyDescriptor,Me=(r,e,i,s)=>{for(var t=s>1?void 0:s?ji(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&Ti(e,i,t),t};let X=class extends g{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return n`
      <div class="container">
        <h1 class="page-title">${this.data.pageTitle}</h1>
        <div class="content">
          ${b(this.data.content)}
  ...
  `;Me([l({type:String})],X.prototype,"lang",2);Me([l({type:Object})],X.prototype,"data",2);X=Me([v("page-privacy")],X);var Ci=Object.defineProperty,Pi=Object.getOwnPropertyDescriptor,ze=(r,e,i,s)=>{for(var t=s>1?void 0:s?Pi(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&Ci(e,i,t),t};let ee=class extends g{constructor(){super(...arguments),this.lang="en",this.data={}}render(){return n`
      <div class="container">
        <h1 class="page-title">${this.data.pageTitle}</h1>
        <div class="content">
          ${b(this.data.content)}
  ...
  `;ze([l({type:String})],ee.prototype,"lang",2);ze([l({type:Object})],ee.prototype,"data",2);ee=ze([v("page-terms")],ee);var Je=Object.freeze,nt=Object.defineProperty,Oi=Object.getOwnPropertyDescriptor,Le=(r,e,i,s)=>{for(var t=s>1?void 0:s?Oi(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&nt(e,i,t),t},Ei=(r,e)=>Je(nt(r,"raw",{value:Je(r.slice())})),Ye;const Hi={users:ge,rocket:Te,lightbulb:Se,gear:st,globe:rt};let te=class extends g{constructor(){super(...arguments),this.lang="en",this.data={}}getJsonLd(){var i;if(!((i=this.data.jobs)!=null&&i.length))return"";const r=this.data.jobs[0],e={"@context":"https://schema.org/","@type":"JobPosting",title:r.title,description:r.description,datePosted:"2025-03-15",employmentType:["FULL_TIME","CONTRACTOR"],jobLocationType:"TELECOMMUTE",applicantLocationRequirements:{"@type":"Country",name:"Japan"},hiringOrganization:{"@type":"Organization",name:"Trio-Soft",sameAs:"https://trio-soft.biz",logo:"https://trio-soft.biz/logo.png"},jobLocation:{"@type":"Place",address:{"@type":"PostalAddress",addressLocality:"Yokohama",addressRegion:"Kanagawa",addressCountry:"JP"}}};return JSON.stringify(e)}render(){var s,t,o;const r=this.lang==="jp"?"主な業務内容":"Responsibilities",e=this.lang==="jp"?"必須スキル・経験":"Requirements",i=this.lang==="jp"?"歓迎スキル":"Nice to Have";return n(Ye||(Ye=Ei([`
      <div class="container">
    ...
    `])),this.data.pageTitle,this.data.introTitle,this.data.intro,this.data.valuesTitle,(s=this.data.values)==null?void 0:s.map(a=>n`
            <div class="value-card">
              <div class="value-icon">${b(Hi[a.icon]||ge)}</div>
              <h3 class="value-title">${a.title}</h3>
              <p class="value-desc">${a.description}</p>
            </div>
          `),this.data.cultureTitle,(t=this.data.cultureItems)==null?void 0:t.map(a=>n`<li>${a}</li>`),this.data.jobsTitle,(o=this.data.jobs)==null?void 0:o.map(a=>{var p,c,d;return n`
          <div class="job-card">
            <h3 class="job-title">${a.title}</h3>
            <div class="job-meta">
              <span>📍 ${a.location}</span>
              <span>💼 ${a.type}</span>
            </div>
            <p class="job-desc">${a.description}</p>
            <div class="job-section-title">${r}</div>
            <ul class="job-list">
              ${(p=a.responsibilities)==null?void 0:p.map(u=>n`<li>${u}</li>`)}
            </ul>
            <div class="job-section-title">${e}</div>
            <ul class="job-list">
              ${(c=a.requirements)==null?void 0:c.map(u=>n`<li>${u}</li>`)}
            </ul>
            <div class="job-section-title">${i}</div>
            <ul class="job-list">
              ${(d=a.niceToHave)==null?void 0:d.map(u=>n`<li>${u}</li>`)}
            </ul>
          </div>
  ...
  `;Le([l({type:String})],te.prototype,"lang",2);Le([l({type:Object})],te.prototype,"data",2);te=Le([v("page-careers")],te);var Mi=Object.defineProperty,zi=Object.getOwnPropertyDescriptor,lt=(r,e,i,s)=>{for(var t=s>1?void 0:s?zi(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&Mi(e,i,t),t};let pe=class extends g{constructor(){super(...arguments),this.data={}}render(){return n`
      <div class="wrapper">
        <div class="content">
          <div class="header">
  ...
  `;lt([l({type:Object})],pe.prototype,"data",2);pe=lt([v("trio-language-selector")],pe);var Li=Object.defineProperty,Ii=Object.getOwnPropertyDescriptor,Ie=(r,e,i,s)=>{for(var t=s>1?void 0:s?Ii(e,i):e,o=r.length-1,a;o>=0;o--)(a=r[o])&&(t=(s?a(e,i,t):a(t))||t);return s&&t&&Li(e,i,t),t};let ie=class extends g{constructor(){super(),this.route=window.location.hash||"#/",this.lang=this.route.startsWith("#/jp")?"jp":"en",window.addEventListener("hashchange",()=>{this.route=window.location.hash||"#/",this.lang=this.route.startsWith("#/jp")?"jp":"en",window.scrollTo(0,0)})}render(){const r=this.lang==="jp"?Mt:Ht;return n`
      <div class="app-container">
        ${this.route==="#/language"?n`<trio-language-selector .data=${r.language}></trio-language-selector>`:n`
    ...
    `}renderPage(r){switch(this.lang==="jp"?this.route.replace("#/jp","")||"/":this.route.replace("#","")||"/"){case"/":return n`<page-home .lang=${this.lang} .data=${r.home}></page-home>`;case"/services":return n`<page-services .lang=${this.lang} .data=${r.services}></page-services>`;case"/cases":return n`<page-cases .lang=${this.lang} .data=${r.cases}></page-cases>`;case"/about":return n`<page-about .lang=${this.lang} .data=${r.about}></page-about>`;case"/contact":return n`<page-contact .lang=${this.lang} .data=${r.contact}></page-contact>`;case"/privacy":return n`<page-privacy .lang=${this.lang} .data=${r.privacy}></page-privacy>`;case"/terms":return n`<page-terms .lang=${this.lang} .data=${r.terms}></page-terms>`;case"/careers":return n`<page-careers .lang=${this.lang} .data=${r.careers}></page-careers>`;default:return n`<page-home .lang=${this.lang} .data=${r.home}></page-home>`}}};ie.styles=f`
    :host {
      display: block;
      min-height: 100vh;
  ...
  `;Ie([he()],ie.prototype,"route",2);Ie([he()],ie.prototype,"lang",2);ie=Ie([v("trio-app")],ie);
