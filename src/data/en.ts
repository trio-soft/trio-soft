    ...
    jobs: [
      {
        ...
        responsibilities: [
          ...
          'Collaborate on system architecture and technology selection',
          'Implement CI/CD pipelines and maintain cloud infrastructure (AWS/GCP)',
          'Integrate AI/ML capabilities into production systems',
          'Participate in code reviews and maintain high code quality',
          'Communicate asynchronously with a distributed team',
        ],
        requirements: [
          '3+ years of backend development experience (Go, Node.js, Python, or similar)',
          'Experience with cloud platforms (AWS or GCP)',
          'Strong understanding of relational and NoSQL databases',
          'Familiarity with containerization (Docker, Kubernetes)',
          'Good communication skills in Japanese or English',
        ],
        niceToHave: [
          'Experience with AI/ML integration or LLM-based applications',
          'Frontend development skills (React, Vue.js, or Lit)',
